...
class MondayControllerTest {
    ...
    void create() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/monday/create")
    ...
    void update() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/monday/update")
                .contentType(APPLICATION_JSON_UTF8)
                .content(requestJson))
                .andExpect(MockMvcResultMatchers.status().isOk());
    ...
    void createDTO() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/monday/createDTO")
                .contentType(APPLICATION_JSON_UTF8)
                .content(requestJson))
                .andExpect(MockMvcResultMatchers.status().isOk());
    ...
    void updateDTO() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/monday/updateDTO")
                .contentType(APPLICATION_JSON_UTF8)
                .content(requestJson))
                .andExpect(MockMvcResultMatchers.status().isOk());
